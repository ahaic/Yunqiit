...
function optionsframework_options() {
	...
	//显示首页白色部分文字
		...
		$options[] = array(
		'name' => __( 'Input Text Mini2', 'theme-textdomain' ),
		'desc' => __( 'A mini text input field2.', 'theme-textdomain' ),
		'id' => 'example_text_mini2',
		'std' => 'Default',
		'class' => 'mini',
		'type' => 'text'
	);
		...
		$options[] = array(
		'name' => __( 'Input Text Mini3', 'theme-textdomain' ),
		'desc' => __( 'A mini text input field3.', 'theme-textdomain' ),
		'id' => 'example_text_mini3',
		'std' => 'Default',
		'class' => 'mini',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __( 'Textarea2', 'theme-textdomain' ),
		'desc' => __( '首页底部图片文字.', 'theme-textdomain' ),
		'id' => 'example_textarea2',
		'std' => 'Default Text',
		'type' => 'textarea'
	);
	...
	$options[] = array(
		'name' => __( '首页底部公司介绍', 'theme-textdomain' ),
		'desc' => __( '首页底部公司介绍.', 'theme-textdomain' ),
		'id' => 'example_textarea3',
		'std' => 'Default Text',
		'type' => 'textarea'
	);
